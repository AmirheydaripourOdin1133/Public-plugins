...
= 1.1.7 =
* هم‌گام‌سازی نسخه محصول برای انتشار نهایی فاز فعلی

= 1.1.6 =
* بازگردانی ساختار جدول سریال‌ها در ادمین + اسکرول افقی موبایل
* آیکون سطل زباله برای پاک کردن فیلد سریال در فرانت

= 1.1.5 =
* جدول لیست سریال‌ها در ادمین ریسپانسیو (مثل نوشته‌ها)
* دکمه پاک کردن (×) فیلد شماره سریال در فرانت
...
= 1.1.7 =
نسخه نهایی فاز فعلی — پس از آپلود کش مرورگر/هاست را پاک کنید.

= 1.1.6 =
نسخه نهایی فاز فعلی — جدول ادمین + پاک کردن سریال در فرانت. پس از آپلود کش را پاک کنید.

= 1.1.5 =
ریسپانسیو ادمین + دکمه پاک کردن سریال در فرانت — پس از آپلود SCSS را کامپایل و کش را پاک کنید.
